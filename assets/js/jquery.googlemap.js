    ...
    $.fn.googleMap = function(params) {
        ...
        this.each(function() {
            var map = new google.maps.Map(this, {
                ...
                disableDoubleClickZoom: params.disableDoubleClickZoom,
                scrollwheel: params.scrollwheel
            });

            if (params.styles) {
                var styledMap = new google.maps.StyledMapType(params.styles, {
                    name: "Styled Map"
                });
                ...
                geocoder.geocode({
                    ...
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        if (params.title != "" && params.text != "" && !params.url) {
                            ...
                            content= "<div class='infowindow_inner'><div class='map_label_heading'>" + params.title + "</div><div class='map_label_address'>" + params.text + "</div></div>";

...
abstract class CFX_Admin {
    ...
    public function save($_newvalue, $_oldvalue) {
        ...
        $_newvalue = array_merge($this->default_settings, $_newvalue);
    ...
    public function dashboard() {
        ...
        <div id="calibrefx-theme-settings-page" class="wrap calibrefx-metaboxes">
            <form method="post" action="options.php">
                ...
                <input type="hidden" name="<?php echo $this->settings_field; ?>[calibrefx_version]>" value="<?php echo esc_attr(calibrefx_get_option('calibrefx_version', $this->settings_field)); ?>" />
                <input type="hidden" name="<?php echo $this->settings_field; ?>[calibrefx_db_version]>" value="<?php echo esc_attr(calibrefx_get_option('calibrefx_db_version', $this->settings_field)); ?>" />

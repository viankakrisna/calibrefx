...
class CFX_Theme_Settings extends Calibrefx_Admin {
    ...
    public function meta_sections() {
        ...
        calibrefx_add_meta_section( 'general', __( 'General Settings', 'calibrefx' ), $calibrefx_target_form, 1, "icon-generalsetting");
        calibrefx_add_meta_section( 'layout', __( 'Layout Settings', 'calibrefx' ), $calibrefx_target_form, 2, "icon-layoutsetting");
        calibrefx_add_meta_section( 'social', __( 'Social Settings', 'calibrefx' ), $calibrefx_target_form, 10, "icon-socialsetting");    

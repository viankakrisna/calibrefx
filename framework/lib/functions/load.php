...
function calibrefx_load_admin_scripts() {
	...
	wp_enqueue_script( 'calibrefx_admin_js', CALIBREFX_JS_URL . '/admin.js', array( 'jquery' ), FRAMEWORK_VERSION, true );
	$params = array(
...
function calibrefx_load_admin_styles() {
	wp_enqueue_style( 'calibrefx_admin_css', CALIBREFX_CSS_URL . '/calibrefx.css', array(), FRAMEWORK_VERSION );
}
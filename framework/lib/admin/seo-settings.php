...
function calibrefx_seo_settings_boxes() {
    global $_calibrefx_seo_settings_pagehook, $calibrefx_current_section;
    ...
    calibrefx_add_meta_box('document', 'professor', 'calibrefx-seo-settings-document-title-settings', __('Document Title Settings', 'calibrefx'), 'calibrefx_seo_settings_document_title_box', $_calibrefx_seo_settings_pagehook, 'main', 'high');
    calibrefx_add_meta_box('document', 'professor', 'calibrefx-seo-settings-document-description-settings', __('Document Description Settings', 'calibrefx'), 'calibrefx_seo_settings_document_description_box', $_calibrefx_seo_settings_pagehook, 'main', 'high');
    calibrefx_add_meta_box('document', 'professor', 'calibrefx-seo-settings-document-keyword-settings', __('Document Keyword Settings', 'calibrefx'), 'calibrefx_seo_settings_document_description_box', $_calibrefx_seo_settings_pagehook, 'main', 'high');

    calibrefx_add_meta_box('home', 'professor', 'calibrefx-seo-settings-home-settings', __('Home Settings', 'calibrefx'), 'calibrefx_seo_settings_home_box', $_calibrefx_seo_settings_pagehook, 'main', 'high');

    calibrefx_add_meta_box('robot', 'professor', 'calibrefx-seo-settings-robot-meta-settings', __('Robot Meta Settings', 'calibrefx'), 'calibrefx_seo_settings_robot_box', $_calibrefx_seo_settings_pagehook, 'main');

    calibrefx_add_meta_box('archive', 'professor', 'calibrefx-seo-settings-archive-settings', __('Archive Settings', 'calibrefx'), 'calibrefx_seo_settings_archive_box', $_calibrefx_seo_settings_pagehook, 'main');
        ...
        <form method="post" action="options.php">
            ...
            <div class="calibrefx-header">
                ...
                <div class="calibrefx-ability">
                    <a class="calibrefx-general" href="<?php echo admin_url("admin.php?page=calibrefx-seo&ability=basic&section=" . $calibrefx_current_section); ?>">Basic</a>
                    <a class="calibrefx-professor" href="<?php echo admin_url("admin.php?page=calibrefx-seo&ability=professor&section=" . $calibrefx_current_section); ?>">Professor</a>
                </div>
            </div>
                    ...
                    <div class="calibrefx-tab">
                        <ul class="calibrefx-tab-option">
                            ...
                            foreach ($calibrefx_sections as $section) {
                                ...
                                $section_link = admin_url('admin.php?page=calibrefx-seo&section=' . $section['slug']);
                        ...
                        <div class="calibrefx-option">
                            ...
                            <div class="postbox-container main-postbox">
                                <?php
                                calibrefx_do_meta_sections($calibrefx_current_section, $_calibrefx_seo_settings_pagehook, 'main', null);
                                ?>
                            </div>

                            <div class="postbox-container side-postbox">
                                <?php
                                calibrefx_do_meta_sections($calibrefx_current_section, $_calibrefx_seo_settings_pagehook, 'side', null);
                                ?>
                            </div>
                            <div class="clear"></div>
                        </div>
